...
设计开发单纤熔接机、带纤机、双芯皮线机、特种光纤熔接机、热剥钳等

设计开发熔接机管控系统（python + django)
...
\item 图像处理、电机控制等关键模块设计开发，其中图像处理相关的有灰尘检查、实时缺陷检测、光纤定位、光纤识别分类、调焦等。
...
\item Linux 操作系统：包括各软件包的补丁、调测、打包，并解决编译时遇到得各种问题，其中有 gcc、 Qt5、 postgresql、 lua、 potrace、 ttf、 libvpx、 opencv、 gsl、 libpng 等
\item FPGA： axi stream 相关 generator、 broadcaster、 VDMA、 scaler、 filter、采集、 blender，图像处理(业务相关)、 SPI client、 LCD 控制、电机控制、 PWM、中断系统等、 register file generator (python script)

\item 工具：
\startigBase
\item 工具： gitlab、tikiwiki、maxima (数学精确计算)、geogebra (3D 建模)、Xilinx ISE、Xilinx Vivado、 poky、 freertos
\item 编程语言：assemble、 C、 C++11、 python、 bash、 lua、 tcl
