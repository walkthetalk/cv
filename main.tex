...
\useURL[github][https://github.com/downloads/walkthetalk/]
...
\useurl[mymail][mailto:niqingliang2003@tom.com][][niqingliang2003@tom.com]

\def\entryspace{0.5em}
\def\cvname{倪庆亮}
\def\cvalias{Y\'i Q\`ing Li\`ang}
\def\cvaddress{江苏省南京市浦口区}
\def\cvpersonalinfo{男，汉族，群众}
\def\cvbirthday{1982 年 10 月}
\def\cvgithub{\from[github]}
\def\cvhomepage{\from[wordpress]}
\def\email{\from[mymail]}
...
% self profile
\subject{自我评价}
9 年工作经验（主要是软件开发），具有扎实的技术功底、刻苦的钻研精神；
...
对于 bash / python / lua 等动态语言或脚本语言也比較熟悉；
另外对于 \TeX、 asymptote、 metapost 等相关技术也有一定的使用经验。
}

\cventry{操作系统}{日常使用的是 ArchLinux。
开发工作主要围绕 Linux 展开，从 bootloader、驱动到上层应用都有所涉及；
涉及交换机、光传输、仪器仪表等领域。}
...
负责整个公司Linux技术平台的搭建；负责新员工技术培训；主持设计开发下一代熔接机控制软件。

软件架构：应用层、业务层、硬件适配层、驱动层

具体功能包括熔接、加热、放电校正、电机测试、灰尘检查、自动调焦等
...
开发环境：Archlinux + gitlab + poky（yocto） + opencv + libpng + libvpx + boost + Texlive + Qt

编程语言：python、Makefile、Con\TeX t、C++11、C、bash

硬件平台： arm s3c2440 s3c6410 exynos4412
}

\cvworkexp{2010 ～ 2012}{浙大网新}{物联网事业部}{杭州}{高级软件工程师}{
