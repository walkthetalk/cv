...
\def\cvaddress{Pukou District, Nanjing City, Jiangsu Province}
\def\cvpersonalinfo{Male, Han}
\def\cvbirthday{1982.10}
  ...
  {\hbox to \hsize
    {\vbox{\hbox{\switchtobodyfont[28pt]\cvname}
      ...
      \vbox{{\color[darkgray]{\it
            ...
            \hbox{\cvpersonalinfo}
            \hbox{\cvbirthday}
            \hbox{\GOTOURL{https://github.com/downloads/walkthetalk/}}
